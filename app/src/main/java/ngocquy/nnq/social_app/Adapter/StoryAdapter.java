...
import ngocquy.nnq.social_app.databinding.StoryRvDesignBinding;
...
public class StoryAdapter extends RecyclerView.Adapter<StoryAdapter.viewHolder>{
    ...
    public void onBindViewHolder(@NonNull viewHolder holder, int position) {
        ...
        if(story.getStories().size() > 0){
            UserStories lastuserStories = story.getStories().get(story.getStories().size()-1);
            Picasso.get().load(lastuserStories.getImage())
                            ...
                            holder.binding.story.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View view) {
                                    ...
                                    for(UserStories stories: story.getStories()){
                                        long yourLongValue = stories.getStoryAt();
                                        Date date = new Date(yourLongValue);
